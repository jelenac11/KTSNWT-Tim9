...
public class MarkRepositoryIntegrationTest {
	...
	public void testFindByGraderAndCulturalOfferId_WithExistingGraderAndCulturalOfferId_ShouldReturnMark() {
		Mark mark = markRepository.findByGraderAndCulturalOfferId(MarkConstants.GRADER, MarkConstants.CULTURAL_OFFER_ID);
		
		assertEquals(MarkConstants.GRADER, mark.getGrader().getId());
	...
	public void testFindByGraderAndCulturalOfferId_WithExistingGraderAndNonExistingCulturalOfferId_ShouldReturnNull() {
		Mark mark = markRepository.findByGraderAndCulturalOfferId(MarkConstants.GRADER, MarkConstants.NON_EXISTING_CULTURAL_OFFER_ID);
	...
	public void testFindByGraderAndCulturalOfferId_WithNonExistingGraderAndCulturalOfferId_ShouldReturnNull() {
		Mark mark = markRepository.findByGraderAndCulturalOfferId(MarkConstants.NON_EXISTING_GRADER, MarkConstants.CULTURAL_OFFER_ID);
	...
	public void testFindByGraderAndCulturalOfferId_WithNonExistingGraderAndNonExistingCulturalOfferId_ShouldReturnNull() {
		Mark mark = markRepository.findByGraderAndCulturalOfferId(MarkConstants.NON_EXISTING_GRADER, MarkConstants.NON_EXISTING_CULTURAL_OFFER_ID);
