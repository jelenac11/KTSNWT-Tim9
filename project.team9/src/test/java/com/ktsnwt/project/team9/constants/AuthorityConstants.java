...
public class AuthorityConstants {
	...
	public static final String AUTHORITY_NAME = "ROLE_ADMIN";
	public static final String NON_EXISTING_AUTHORITY_NAME = "ROLE_SUPERADMIN";
	
	public static final Long ID = 1L;
	public static final Long NON_EXISTING_ID = 100L;
	
	public static final String NON_EXISTING_TOKEN = "token";
	...
	public static final Long USER_ID_WITH_TOKEN = 7L;
}
